---
name: skill-creation
description: "Create, improve, and manage skills. Use when creating new skills from scratch or session learnings, improving existing skills from preferences, analyzing sessions for patterns worth codifying, or understanding best practices for agentic skill design. Meta-skill for self-improvement and continuous learning."
