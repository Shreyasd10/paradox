---
name: human-writing
description: "Remove signs of AI-generated writing so text sounds natural and human-written. Use when editing or reviewing markdown, technical docs, emails, blog posts, PRDs, or any writing content. Based on Wikipedia Signs of AI writing; fixes inflated symbolism, promotional language, superficial -ing analyses, vague attributions, em dash overuse, rule of three, AI vocabulary, negative parallelisms, and excessive conjunctive phrases."
